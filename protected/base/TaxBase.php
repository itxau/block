...
class TaxBase extends BaseExt
{
    ...
    public function checkRight($actionId)  {
        ...
        //不需要权限控制
        $notRights=array(
            "taxbureau@index","taxbureau@info",
            "taxbureau@password","taxbureau@password_act",
            "taxbureau@headpic","taxbureau@headpic_save",
            "taxbureau@clear","taxbureau@clear_act"
        );
