...
class TaxbureauController extends TaxBase
{
    ...
    public function index() {   
        ...
        $prdNum=$entity->count();
        $this->assign("prdNum",$prdNum);
        $prdlist=$entity->queryAll(array(),"",10);
        $this->assign("prdlist",$prdlist);

        $entity=new DeclaretaxEntity();
        $dclNum=$entity->count();
        $this->assign("dclNum",$dclNum);
        $dclist=$entity->queryAll(array(),"",10);
