...
class TaxMenu
{
    ...
    public function __construct()
    {
        $nodes= array(
            /*
            '/taxbureau/online'=> array(
                'name'=>'企业在线','parent'=>'onkey','icon'=>'fa-comments'
            ),
            */
            '/taxreco/index'=> array(
                'name'=>'备案管理','parent'=>'onkey','icon'=>'fa-suitcase'
            ),
            '/taxdltx/index'=> array(
                'name'=>'申报管理','parent'=>'onkey','icon'=>'fa-clone'
            ),
             '/taxinvo/index'=>array(
                'name'=>'购票审批','parent'=>'onkey','icon'=>'fa-book'
            ),
            '/taxrftx/index'=> array(
                'name'=>'退税审批','parent'=>'onkey','icon'=>'fa-window-restore'
            ),
            '/taxdstx/index'=> array(
                'name'=>'所得税优惠','parent'=>'onkey','icon'=>'fa-window-restore'
            ),
            '/taxdash/index'=> array(
                'name'=>'数据协同','parent'=>'gov2tax','icon'=>'fa-exchange'
            ),
            /*
            '/taxbureau/tzonline'=> array(
                'name'=>'税政在线','parent'=>'gov2tax','icon'=>'fa-comments'
            ),
            */
            '/taxdept/index'=> array(
                'name'=>'部门管理','parent'=>'system','icon'=>'fa-user'
            ),
            ...
            '/taxgtep/index'=> array(
                'name'=>'企业授权','parent'=>'system','icon'=>'fa-share-alt'
            ),
            '/taxgtgv/index'=> array(
                'name'=>'政务授权','parent'=>'system','icon'=>'fa-star'
            )
        );
        
        //分组菜单
        $subMenu = array(
            'index'  =>array('name'=>'一局式',  'parent'=>'system','icon'=>'fa-dashboard',
                'url'=>'/taxbureau/index'),
            'hr'  =>array('name'=>'hr', 'parent'=>'system','icon'=>'','url'=>''),
            'enterprise' =>array('name'=>'一户式','parent'=>'system','icon'=>'fa-folder','url'=>'/taxetp/index'),
            'government' =>array('name'=>'政务单位','parent'=>'system','icon'=>'fa-building','url'=>'/taxgov/index'),
            'taxdahs' =>array('name'=>'企业数据','parent'=>'system','icon'=>'fa-database','url'=>'/taxdahs/index'),
            'meeting'  =>array('name'=>'视频会议',  'parent'=>'system','icon'=>'fa-video-camera','url'=>'/taxmeet/index'),
            'hr2'  =>array('name'=>'hr', 'parent'=>'system','icon'=>'','url'=>''),
            'gov2tax' =>array('name'=>'政务通','parent'=>'system','icon'=>'fa-building','url'=>''),
            'onkey' =>array('name'=>'服务中心','parent'=>'system','icon'=>'fa-shopping-bag','url'=>''),
            'taxanno' =>array('name'=>'公告通知','parent'=>'system','icon'=>'fa-commenting','url'=>'/taxanno/index'),
