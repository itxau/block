		...
		<div class="page-wrapper">
            <div class="container-fluid">
				...
				<div class="panel panel-default card-view">
	            	<form action="<?php echo urldecode(Url::urlFormat("/taxdahs/index"));?>" method="post" id="main_form" name="main_form">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            <div class="form-inline">
                ...
                <button type="submit" class="btn btn-primary btn-rounded btn-sm">查找
                </button>
             </div>
        </div>
        <div class="clearfix"></div>
                ...
                <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a style="color: blue;" href="<?php echo urldecode(Url::urlFormat("/taxdahs/downfile/rid/$item[id]/tid/$item[txid]/aid/$item[address_id]"));?>" target="_blank"><?php echo TString::msubstr($item["txid"],0,40);?></a></td>
                            <td class="text-center">
                                <i class="fa fa-lg <?php echo Common::getExtensionIcon($item['ext']);?>"></i>
                            </td>
