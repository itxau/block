		...
		<div class="page-wrapper">
            <div class="container-fluid">
				...
				<div class="panel panel-default card-view">
	            	<div class="container-fluid">
  <form action="<?php echo urldecode(Url::urlFormat("/taxdash/index"));?>" method="post" id="main_form" name="main_form">
          ...
          <table class="table table-responsive table-hover">
              ...
              <tbody>
                  ...
                  <tr data-refid="<?php echo isset($item['id'])?$item['id']:"";?>">
                      ...
                      <td><?php echo isset($item["frmname"])?$item["frmname"]:"";?></td>
                      <td><?php echo TString::msubstr($item["title"],0,30);?></td>
...
<?php $widget = Widget::createWidget('public');$widget->_action = "commandWidget";$widget->con = "taxdash";$widget->width = "800";$widget->height = "450";$widget->title = "数据协同";$widget->cache = "false";$widget->run();?>
