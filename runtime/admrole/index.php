		...
		<div class="page-wrapper">
            <div class="container-fluid">
				...
				<div class="panel panel-default card-view">
	            	<form action="<?php echo urldecode(Url::urlFormat("/taxrole/index"));?>" method="post" id="main_form" name="main_form">
        ...
        <div class="pull-right">
            <div class="form-inline">
                <div class="form-group">
                    <input type="text" class="form-control seach" id="ct__name" name="ct__name" placeholder="角色名称" value="<?php echo isset($ct__name)?$ct__name:"";?>">
                </div>
                <div class="form-group">
                ...
                <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo isset($item["grantofetp"])?$item["grantofetp"]:"";?></td>
                            <td><?php echo isset($item["grantofgov"])?$item["grantofgov"]:"";?></td>
                            <td><?php echo isset($item["created_time"])?$item["created_time"]:"";?></td>
                            <td><?php echo isset($item["updated_time"])?$item["updated_time"]:"";?></td>
                            ...
                            <td style="text-align: center;">
                                <div class="dropdown">
                                    ...
                                    <ul role="menu" class="dropdown-menu" data-refid="<?php echo isset($item['id'])?$item['id']:"";?>">
                                        ...
                                        <?php }else{?>
                                        <li>
                                            <a onclick="changeStatus(<?php echo isset($item['id'])?$item['id']:"";?>,1);"><i class="fa fa-fw fa-unlock-alt"></i><span>启用</span></a>
                                        </li>
                                        <?php }?>
                                        <li class="divider"></li>
                                        <li>
...
<?php $widget = Widget::createWidget('public');$widget->_action = "commandWidget";$widget->con = "taxrole";$widget->width = "1000";$widget->height = "600";$widget->title = "角色";$widget->cache = "false";$widget->run();?>
