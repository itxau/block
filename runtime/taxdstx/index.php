		...
		<div class="page-wrapper">
            <div class="container-fluid">
				...
				<div class="panel panel-default card-view">
	            	<div class="container-fluid">
  <form action="<?php echo urldecode(Url::urlFormat("/taxdstx/index"));?>" method="post" id="main_form" name="main_form">
          ...
          <table class="table table-responsive table-hover">
              ...
              <tbody>
                  ...
                  <tr data-refid="<?php echo isset($item['id'])?$item['id']:"";?>">
                      ...
                      <td><?php echo TString::msubstr($item["items"],0,30);?></td>
                      <td><?php echo TString::msubstr($item["content"],0,30);?></td>
...
<?php $widget = Widget::createWidget('public');$widget->_action = "commandWidget";$widget->con = "taxdstx";$widget->width = "900";$widget->height = "550";$widget->title = "所得税优惠申请";$widget->cache = "false";$widget->run();?> 
