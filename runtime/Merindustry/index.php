            ...
            <div class="container-fluid">
            	<div class="row heading-bg">
				    ...
				    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				      <ol class="breadcrumb">
				        <li><a href="<?php echo urldecode(Url::urlFormat("/admin/index"));?>">首页</a></li>
...
<form action="<?php echo urldecode(Url::urlFormat("/merindustry/index"));?>" method="post" id="main_form" name="main_form">
                            ...
                            <td style="text-align: center;">
                                <div class="dropdown">
                                    ...
                                    <ul role="menu" class="dropdown-menu" data-refid="<?php echo isset($item['id'])?$item['id']:"";?>">
                                        ...
                                        <li>
                                            <a href="javascript:;" onclick="changeStatus(<?php echo isset($item['id'])?$item['id']:"";?>,2);"><i class="fa fa-fw fa-lock"></i><span>禁止</span></a>
                                        </li>
                                        <?php }else{?>
                                        <li>
                                            <a href="javascript:;" onclick="changeStatus(<?php echo isset($item['id'])?$item['id']:"";?>,1);"><i class="fa fa-fw fa-unlock-alt"></i><span>正常</span></a>
                                        </li>
                                        <?php }?>
                                        <li class="divider"></li>
                                        <li>
...
<?php $widget = Widget::createWidget('public');$widget->_action = "commandWidget";$widget->con = $con;$widget->width = "600";$widget->height = "300";$widget->title = "用户";$widget->cache = "false";$widget->run();?>
