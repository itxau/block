		...
		<div class="page-wrapper">
            <div class="container-fluid">
				...
				<div class="panel panel-default card-view">
	            	<form action="<?php echo urldecode(Url::urlFormat("/taxmeet/index"));?>" method="post" id="main_form" name="main_form">
                ...
                <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo isset($item["room"])?$item["room"]:"";?></td>
                            <td><?php echo isset($item["begin_time"])?$item["begin_time"]:"";?></td>
                            <td><?php echo isset($item["end_time"])?$item["end_time"]:"";?></td>
                            <td><?php echo isset($item["created_time"])?$item["created_time"]:"";?></td>
                            <td class="text-center">
                                <a style="color: green;" href="<?php echo isset($item['auth_url'])?$item['auth_url']:"";?>" target="_blank"><i class="fa fa-video-camera"></i></a>
                            </td>
                            ...
                            <td style="text-align: center;">
                                <div class="dropdown">
                                    ...
                                    <ul role="menu" class="dropdown-menu" data-refid="<?php echo isset($item['id'])?$item['id']:"";?>">
                                        ...
                                        <li>
                                            <a onclick="changeStatus(<?php echo isset($item['id'])?$item['id']:"";?>,2);"><i class="fa fa-fw fa-lock"></i><span>禁止</span></a>
                                        </li>
                                        <?php }else{?>
                                        <li>
                                            <a onclick="changeStatus(<?php echo isset($item['id'])?$item['id']:"";?>,1);"><i class="fa fa-fw fa-unlock-alt"></i><span>开启</span></a>
                                        </li>
                                        <?php }?>
                                        <li class="divider"></li>
                                        <li>
...
<?php $widget = Widget::createWidget('public');$widget->_action = "commandWidget";$widget->con = "taxmeet";$widget->width = "880";$widget->height = "450";$widget->title = "视频会议";$widget->cache = "false";$widget->run();?>

<script type="text/javascript">

    function vido() {
      window.open("http://ws.hst.com/roomMgr/entermeeting.jsp?roomID=3079082&userName=孙工&userPwd=123456","ddd");
    }
