		...
		<div class="page-wrapper">
            <div class="container-fluid">
				...
				<div class="panel panel-default card-view">
	            	<div class="container-fluid">
  <form action="<?php echo urldecode(Url::urlFormat("/taxdltx/index"));?>" method="post" id="main_form" name="main_form">
          ...
          <table class="table table-responsive table-hover">
              ...
              <tbody>
                  ...
                  <tr data-refid="<?php echo isset($item['id'])?$item['id']:"";?>">
                      ...
                      <td><?php echo isset($item['total_amount'])?$item['total_amount']:"";?></td>
                      <td><?php echo isset($item['apply_amount'])?$item['apply_amount']:"";?></td>
                      <td><?php echo isset($item["approved_note"])?$item["approved_note"]:"";?></td>
...
<?php $widget = Widget::createWidget('public');$widget->_action = "commandWidget";$widget->con = "taxdltx";$widget->width = "800";$widget->height = "450";$widget->title = "税务申请";$widget->cache = "false";$widget->run();?>
