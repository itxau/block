		...
		<div class="page-wrapper">
            <div class="container-fluid">
				...
				<div class="panel panel-default card-view">
	            	<div class="container-fluid">
  <form action="<?php echo urldecode(Url::urlFormat("/taxinvo/index"));?>" method="post" id="main_form" id="main_form" name="main_form">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            <div class="form-inline">
                ...
                <div class="form-group">
                    <select class="form-control seach" name="buy_type" id="buy_type">
                        <?php $widget = Widget::createWidget('list');$widget->_action = "buyinvoicetypeWidget";$widget->cache = "false";$widget->run();?>
                    </select>
                </div>
                <div class="form-group">
                    <select class="form-control seach" name="invoicetype_id" id="invoicetype_id">
                       <?php $widget = Widget::createWidget('list');$widget->_action = "invoicetypeWidget";$widget->cache = "false";$widget->run();?>
                    </select>
                </div>
                <div class="form-group">
          ...
          <table class="table table-responsive table-hover">
              ...
              <tbody>
                  ...
                  <tr data-refid="<?php echo isset($item['id'])?$item['id']:"";?>">
                      ...
                      <td><?php echo isset($item["buytypename"])?$item["buytypename"]:"";?></td>
                      <td><?php echo isset($item["invoicename"])?$item["invoicename"]:"";?></td>
                      <td><?php echo isset($item["buy_num"])?$item["buy_num"]:"";?></td>
                      <td><?php echo isset($item["submit_time"])?$item["submit_time"]:"";?></td>
...
<?php $widget = Widget::createWidget('public');$widget->_action = "commandWidget";$widget->con = "taxinvo";$widget->width = "800";$widget->height = "400";$widget->title = "购票申请";$widget->cache = "false";$widget->run();?>

<script type="text/javascript">
    $(document).ready(function() {
      $("#status").val("<?php echo isset($status)?$status:"";?>");
      $("#buy_type").val("<?php echo isset($buy_type)?$buy_type:"";?>");
      $("#invoicetype_id").val("<?php echo isset($invoicetype_id)?$invoicetype_id:"";?>");
    });
</script>
